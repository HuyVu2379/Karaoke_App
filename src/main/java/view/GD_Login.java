...
public class GD_Login extends JFrame {
    ...
    public GD_Login() throws RemoteException {
        ...
        btnDangNhap.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (tenDangNhap.isEmpty() || matKhau.isEmpty()) {
                    ...
                    try {
                        taiKhoan = dao.getTaiKhoan(tenDangNhap, matKhau);
        ...
        txtMatKhau = new
                ...
                JPasswordField("Dat123456@");
        txtMatKhau.setFont(new
        ...
        txtTenDangNhap = new JTextField("luongtandat");
        txtTenDangNhap.setFont(new
        ...
        lbTenDangNhap.setForeground(new
        ...
        txtTitle.setFont(new

                Font("Tahoma", Font.BOLD, 18));
        txtTitle.setBackground(new

                Color(255, 255, 128));
        txtTitle.setHorizontalAlignment(SwingConstants.CENTER);
        txtTitle.setForeground(new
        ...
        lbBackGroundKaraoke.setIcon(new

                ImageIcon("src\\main\\resources\\image\\icon\\login_image.png"));
        lbBackGroundKaraoke.setBounds(0, 0, 684, 661);
        lbBackGroundKaraoke.setPreferredSize(new

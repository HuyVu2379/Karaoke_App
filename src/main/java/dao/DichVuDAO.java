...
public interface DichVuDAO extends Remote  {
	...
	List<DichVu> executeGetDichVuPage(int page, int size) throws RemoteException;
	DichVu getDichVuTheoMa(String maDv) throws RemoteException;
	List<DichVu> getDichVuByTrangThai(TrangThaiDichVu trangThai) throws RemoteException;

...
//        List<PhieuDatPhong> list = phieuDatPhongDAO.getPhieuDatPhongByMaHoaDon("HD041123001");
//        for (PhieuDatPhong phieuDatPhong : list) {
//            System.out.println(phieuDatPhong);
//        }
//        PhieuDatPhong phieuDatPhong = new PhieuDatPhong("PD041123001", "KH.041123.001", "NV230001", "P0101", Time.valueOf("00:00:00"), Date.valueOf("2024-04-21"));
//        boolean test2 = phieuDatPhongDAO.changeRoom();
    }
}
